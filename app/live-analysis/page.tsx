...
export default function LiveAnalysis() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface border border-[#ECE8DE] rounded-[18px] p-6 shadow-standard max-w-2xl">
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#F2F1EC] border border-[#ECE8DE] rounded-[14px] px-3.5 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#F8CB46]/20 focus:border-[#F8CB46] font-medium text-[#171717]"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#F2F1EC] border border-[#ECE8DE] rounded-[14px] px-3.5 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#F8CB46]/20 focus:border-[#F8CB46] leading-relaxed font-medium text-[#171717]"
            />
          </div>
