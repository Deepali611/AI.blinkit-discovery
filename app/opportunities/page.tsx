  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <PageHeader
        ...
        subtitle="Stage 8 — Opportunities"
      />
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          {opportunities.map((opp, idx) => {
            const segmentDisplay = idx === 3
              ? "unclassified — directional finding, recommend validating with H4 before building"
              : opp.segment;
            ...
            return (
              <div
                key={opp.title}
                id={`opp-${idx}`}
                className="bg-surface border border-[#ECE8DE] rounded-[18px] p-6 shadow-standard space-y-4 scroll-mt-6"
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-sans text-[9px] font-bold text-[#8C8C8C] uppercase tracking-wider">
                    Growth Experiment Proposal {idx + 1}
                  </span>
                </div>
      ...
      <div className="flex justify-between items-center pt-4 border-t border-[#ECE8DE]">
        ...
        >
          <ArrowLeft size={14} strokeWidth={1.5} /> Stage 7: Segmentation & Hypotheses
        </Link>
        <Link
          href="/sandbox"
